(function(){
  var TRANSLATIONS = {
    de: {
      ...
      nav: { leistungen: 'Leistungen', warum: 'Warum wir', ablauf: 'Ablauf', faq: 'FAQ', team: 'Team', cta: 'Erstgespräch' },
      hero: {
        eyebrow: 'LUSIDE',
    ...
    en: {
      ...
      nav: { leistungen: 'Services', warum: 'Why us', ablauf: 'Process', faq: 'FAQ', team: 'Team', cta: 'Get in touch' },
      hero: {
        eyebrow: 'LUSIDE',
