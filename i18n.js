(function(){
  var TRANSLATIONS = {
    de: {
      ...
      nav: { leistungen: 'Leistungen', warum: 'Warum wir', ablauf: 'Ablauf', faq: 'FAQ', team: 'Team', seminar: 'Seminar', erstberatung: 'Erstberatung', cta: 'Erstgespräch', home_short: 'Lusides' },
      hero: {
        eyebrow: 'LUSIDES',
      ...
      erstberatung_page: {
        ...
        sub: '30 oder 60 Minuten, per Microsoft Teams — damit ihr schnell einschätzen könnt, ob und wie eine Zusammenarbeit für euch Sinn macht.',
        cta1: 'Jetzt anfragen',
        cta2: 'Wie es abläuft',
        about_label: 'WORUM ES GEHT',
        about_h2: 'Kein Verkaufsgespräch — eine ehrliche Einschätzung.',
        about_p: 'Die Erstberatung ist ein bezahltes, fokussiertes Gespräch direkt mit Marko Katalan — anders als das kostenlose Kontaktformular, bei dem wir zuerst prüfen, ob wir weiterhelfen können. Hier bekommt ihr in jedem Fall eine konkrete, ehrliche Einschätzung zu eurer Situation.',
        pricing_label: 'PREISE',
        pricing_h2: 'Zwei Optionen.',
        price30_duration: '30 MINUTEN',
        price30_unit: ' / Sitzung',
        price30_desc: 'Für eine erste, gezielte Einschätzung eurer Situation.',
        price60_duration: '60 MINUTEN',
        price60_unit: ' / Sitzung',
        price60_desc: 'Für ein tieferes Gespräch mit mehr Raum für Rückfragen.',
        price_cta: 'Diese Option wählen',
        who_label: 'MIT',
        chip_format_k: 'FORMAT',
        who_h2: 'Wer das Gespräch führt.',
        who_link: 'Mehr zum Team',
        ablauf_h2: 'So geht es nach deiner Anfrage weiter.',
        ablauf_step1_h: 'Anfrage stellen',
        ablauf_step1_p: 'Über das Formular unten — mit gewünschter Dauer und deinen Kontaktdaten.',
        ablauf_step2_h: 'Projektbogen ausfüllen',
        ablauf_step2_p: 'Direkt im Anschluss ein paar gezielte Fragen zu deiner Situation, damit Marko sich vorbereiten kann.',
        ablauf_step3_h: 'Terminbestätigung',
        ablauf_step3_p: 'Du erhältst per E-Mail einen Terminvorschlag, die Zahlungsdetails und den Teams-Link.',
        faq_h2: 'Häufige Fragen zur Erstberatung',
        faq_q1: 'Ist die Erstberatung kostenlos?', faq_a1: 'Nein. Die Erstberatung ist eine kostenpflichtige, fokussierte Sitzung mit Marko Katalan — 250 € für 30 Minuten oder 450 € für 60 Minuten.',
        faq_q2: 'Was ist der Unterschied zum kostenlosen Kontaktformular?', faq_a2: 'Das Kontaktformular auf der Startseite ist eine unverbindliche Anfrage, bei der wir zuerst prüfen, ob wir weiterhelfen können. Die Erstberatung ist ein garantiertes, strukturiertes 1:1-Gespräch direkt mit Marko Katalan.',
        faq_q3: 'Wie und wann bezahle ich?', faq_a3: 'Die Zahlungsdetails erhältst du zusammen mit der Terminbestätigung per E-Mail.',
        faq_q4: 'Wie läuft der Call ab?', faq_a4: 'Per Microsoft Teams, direkt mit Marko Katalan. Der Projektbogen im Anschluss an deine Anfrage hilft ihm, sich gezielt auf das Gespräch vorzubereiten.',
        form_label: 'ANFRAGE',
        form_h2: 'Erstberatung anfragen.',
        form_copy: 'Nach dem Absenden geht es direkt weiter zum Projektbogen, damit Marko sich auf euer Gespräch vorbereiten kann.',
        form_duration: 'Gewünschte Dauer',
        form_duration_30: '30 Minuten — 250 €',
        form_duration_60: '60 Minuten — 450 €',
        form_message: 'Kurz, worum es geht (optional)',
      ...
      projektbogen_page: {
        ...
        f_situation: 'Wie sieht eure aktuelle Situation aus?',
        f_versucht: 'Was habt ihr bereits versucht?',
        f_optional: '(optional)',
        f_ziel: 'Was soll am Ende des Gesprächs für euch herauskommen?',
        f_dringlichkeit: 'Dringlichkeit',
        f_dringlichkeit_1: 'In den nächsten Wochen',
        f_dringlichkeit_2: 'In den nächsten 3 Monaten',
        f_dringlichkeit_3: 'Noch offen',
        f_entscheidung: 'Ich kann diese Entscheidung selbst treffen oder bin maßgeblich daran beteiligt.',
        submit: 'Projektbogen absenden',
        form_success: 'Danke! Marko meldet sich mit einem Terminvorschlag und den Zahlungsdetails.',
        form_error: 'Da ist etwas schiefgelaufen. Bitte versuche es erneut oder schreib uns direkt per E-Mail.'
      },
      impressum_page: {
    ...
    en: {
      ...
      nav: { leistungen: 'Services', warum: 'Why us', ablauf: 'Process', faq: 'FAQ', team: 'Team', seminar: 'Seminar', erstberatung: 'Initial consultation', cta: 'Get in touch', home_short: 'Lusides' },
      hero: {
        eyebrow: 'LUSIDES',
      ...
      erstberatung_page: {
        ...
        sub: "30 or 60 minutes, via Microsoft Teams — so you can quickly assess whether and how working together makes sense for you.",
        cta1: 'Request now',
        cta2: 'How it works',
        about_label: "WHAT IT'S ABOUT",
        about_h2: 'Not a sales pitch — an honest assessment.',
        about_p: "The initial consultation is a paid, focused conversation directly with Marko Katalan — unlike the free contact form, where we first check whether we can genuinely help. Here you get a concrete, honest assessment of your situation either way.",
        pricing_label: 'PRICING',
        pricing_h2: 'Two options.',
        price30_duration: '30 MINUTES',
        price30_unit: ' / session',
        price30_desc: 'For a first, focused assessment of your situation.',
        price60_duration: '60 MINUTES',
        price60_unit: ' / session',
        price60_desc: 'For a deeper conversation with more room for questions.',
        price_cta: 'Choose this option',
        who_label: 'WITH',
        chip_format_k: 'FORMAT',
        who_h2: 'Who leads the call.',
        who_link: 'More about the team',
        ablauf_h2: "What happens after your request.",
        ablauf_step1_h: 'Submit a request',
        ablauf_step1_p: 'Via the form below — with your preferred duration and contact details.',
        ablauf_step2_h: 'Fill out the project brief',
        ablauf_step2_p: 'Right after, a few focused questions about your situation so Marko can prepare.',
        ablauf_step3_h: 'Confirmation',
        ablauf_step3_p: "You'll receive a proposed time, payment details, and the Teams link by email.",
        faq_h2: 'Frequently asked questions about the initial consultation',
        faq_q1: 'Is the initial consultation free?', faq_a1: 'No. The initial consultation is a paid, focused session with Marko Katalan — €250 for 30 minutes or €450 for 60 minutes.',
        faq_q2: 'What is the difference to the free contact form?', faq_a2: "The contact form on the homepage is a no-obligation inquiry, where we first check whether we can genuinely help. The initial consultation is a guaranteed, structured 1:1 call directly with Marko Katalan.",
        faq_q3: 'How and when do I pay?', faq_a3: "You'll receive the payment details together with the appointment confirmation by email.",
        faq_q4: 'How does the call work?', faq_a4: "Via Microsoft Teams, directly with Marko Katalan. The project brief after your request helps him prepare specifically for the conversation.",
        form_label: 'REQUEST',
        form_h2: 'Request an initial consultation.',
        form_copy: "After submitting, you'll go straight to the project brief so Marko can prepare for your call.",
        form_duration: 'Preferred duration',
        form_duration_30: '30 minutes — €250',
        form_duration_60: '60 minutes — €450',
        form_message: "Briefly, what it's about (optional)",
      ...
      projektbogen_page: {
        ...
        f_situation: "What does your current situation look like?",
        f_versucht: 'What have you already tried?',
        f_optional: '(optional)',
        f_ziel: 'What should come out of the call for you?',
        f_dringlichkeit: 'Urgency',
        f_dringlichkeit_1: 'In the next few weeks',
        f_dringlichkeit_2: 'In the next 3 months',
        f_dringlichkeit_3: 'Still open',
        f_entscheidung: "I can make this decision myself, or I'm significantly involved in it.",
        submit: 'Submit project brief',
        form_success: "Thanks! Marko will get back to you with a proposed time and the payment details.",
        form_error: 'Something went wrong. Please try again or email us directly.'
      },
      impressum_page: {
